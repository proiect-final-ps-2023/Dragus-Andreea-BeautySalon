...
public class AppointmentServiceImpl implements AppointmentService {
    ...
    @Override
    public void saveAppointmentToXML(Long id) throws JAXBException {
        ...
        if(appointment.isPresent()) {
            ...
            marshaller.marshal(appointment.get(), new File("Appointment_number_"+ id+".xml"));
        } else {
            throw new AppointmentNotFoundException("Could not save appointment to XML because it was not found in DB");
        }
    }
}
